// Parse pasted opening-hours text into the editor form shape — the parser behind
// the admin "Paste hours" box. Handles per-line day blocks, compact single
// lines, split hours, overnight windows, "(Closed X)" exceptions and the messy
// real-world formats hours arrive in.
//
// parseHoursText(str) -> { hours, warnings }. Never throws; a bad paste yields
// whatever it could read plus warnings for the admin to fix by hand.
//
// NOTE: backend/utils/parseLegacyHours.js is a snapshot copy of this file used
// by the legacy-hours migration. Keep the two in sync when changing parse rules.

import { blankOpeningHours } from "./hoursShape";
