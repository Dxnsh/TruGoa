...
const FoodForm = ({ business, onClose, onSaved }) => {
    ...
    >
      ...
      <Row>
        <Field label="Hours Note (freeform, optional)">
          <input style={inputStyle} value={form.openingHoursNote} onChange={e => set("openingHoursNote", e.target.value)} placeholder="Kitchen closes 30 min early · Seasonal" />
        </Field>
        <Field label="Phone">
